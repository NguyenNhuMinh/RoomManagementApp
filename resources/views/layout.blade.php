...
<html lang="en">
    			...
    			<div class="col-lg-12 pr-1 aside-stretch">
	        		...
	        		<div class="row">
	        			...
	        			<div class="col-md d-flex">
			              ...
			              <a href="{{URL::to('')}}" class="btn btn-black py-5 py-md-3 px-4 align-self-stretch d-block"><span>Check Availability <small>Best Price Guaranteed!</small></span></a>
			            </div>
	        			</div>
	        		</div>
	        	</form>
  ...
  <script src="{{asset('public/fontend/js/jquery.mb.YTPlayer.min.js')}}"></script>
