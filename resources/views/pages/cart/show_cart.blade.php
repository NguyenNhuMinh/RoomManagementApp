    ...
    <div class="d-flex justify-content-center row">
        <div class="col-md-8">
            ...
            <div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white mt-4 px-3 rounded">
                <div class="mr-1"><img name="room_details_image" class="rounded" src="{{}}" width="70"></div>
                <div class="d-flex flex-column align-items-center product-details"><span class="font-weight-bold" name="room_details_name">{{}}Basic T-shirt</span>
                    <div class="d-flex flex-row product-desc">
                        <div class="size mr-1"><span class="text-grey" name="room_details_price">Price:</span><span class="font-weight-bold">&nbsp;M</span></div>
